...
def _default_catalog() -> Dict[str, Any]:
    return {
        ...
        "datasets": {
            "production": {"display_name": "Production", "description": "Daily production quantity.", "keywords": ["production", "output", "생산", "실적"], "tool_name": "get_production_data", "db_key": "PKG_RPT", "required_params": ["date"], "primary_quantity_column": "production", "columns": [{"name": "WORK_DT"}, {"name": "OPER_NAME"}, {"name": "MODE"}, {"name": "LINE"}, {"name": "DEN"}, {"name": "TECH"}, {"name": "MCP_NO"}, {"name": "production"}], "filter_mappings": {"process_name": ["OPER_NAME"], "mode": ["MODE"], "line": ["LINE"], "den": ["DEN"], "tech": ["TECH"], "mcp_no": ["MCP_NO"], "product_name": ["MCP_NO", "MODE", "DEN", "TECH"]}},
            "target": {"display_name": "Target", "description": "Daily target quantity.", "keywords": ["target", "plan", "목표", "계획"], "tool_name": "get_target_data", "db_key": "PKG_RPT", "required_params": ["date"], "primary_quantity_column": "target", "columns": [{"name": "WORK_DT"}, {"name": "OPER_NAME"}, {"name": "MODE"}, {"name": "LINE"}, {"name": "DEN"}, {"name": "TECH"}, {"name": "MCP_NO"}, {"name": "target"}], "filter_mappings": {"process_name": ["OPER_NAME"], "mode": ["MODE"], "line": ["LINE"], "den": ["DEN"], "tech": ["TECH"], "mcp_no": ["MCP_NO"], "product_name": ["MCP_NO", "MODE", "DEN", "TECH"]}},
            "wip": {"display_name": "WIP", "description": "Work in process quantity.", "keywords": ["wip", "재공"], "tool_name": "get_wip_status", "db_key": "PKG_RPT", "required_params": ["date"], "primary_quantity_column": "wip_qty", "columns": [{"name": "WORK_DT"}, {"name": "OPER_NAME"}, {"name": "MODE"}, {"name": "LINE"}, {"name": "wip_qty"}], "filter_mappings": {"process_name": ["OPER_NAME"], "mode": ["MODE"], "line": ["LINE"]}},
            "equipment": {"display_name": "Equipment", "description": "Equipment utilization.", "keywords": ["equipment", "설비", "가동률"], "tool_name": "get_equipment_status", "db_key": "PKG_RPT", "required_params": ["date"], "primary_quantity_column": "utilization_rate", "columns": [{"name": "WORK_DT"}, {"name": "OPER_NAME"}, {"name": "EQUIPMENT_ID"}, {"name": "utilization_rate"}], "filter_mappings": {"process_name": ["OPER_NAME"], "equipment_id": ["EQUIPMENT_ID"]}},
        },
    }
