...
def _default_catalog() -> Dict[str, Any]:
    return {
        ...
        "datasets": {
            ...
            "wip": {"display_name": "WIP", "description": "Work in process quantity.", "keywords": ["wip", "재공"], "tool_name": "get_wip_status", "db_key": "PKG_RPT", "required_params": ["date"]},
            "equipment": {"display_name": "Equipment", "description": "Equipment utilization.", "keywords": ["equipment", "설비", "가동률"], "tool_name": "get_equipment_status", "db_key": "PKG_RPT", "required_params": ["date"]},
        },
    }
