...
class OracleDataRetriever(Component):
    display_name = "V2 Oracle Data Retriever"
    description = "Standalone Oracle retriever. Executes every planned job with internal SQL tool functions."
    icon = "DatabaseZap"
    name = "V2OracleDataRetriever"

    inputs = [
        DataInput(name="intent_plan", display_name="Intent Plan", info="Output from V2 Normalize Intent Plan.", input_types=["Data", "JSON"]),
