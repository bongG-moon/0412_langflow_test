...
class MongoDBDomainLoader(Component):
    display_name = "V2 MongoDB Domain Loader"
    description = "Standalone MongoDB loader for v2 domain documents or gbn/key/payload item documents."
    icon = "Database"
    name = "V2MongoDBDomainLoader"
