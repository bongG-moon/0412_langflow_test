...
prepare_retrieval_source_results = __lf_runtime_services_runtime_service__prepare_retrieval_source_results


class ExecuteJobsComponent(Component):
    display_name = "Execute Jobs"
    ...
    outputs = [Output(name="state_out", display_name="State", method="execute_jobs", types=["Data"], selected="Data")]
    ...
    def execute_jobs(self):
        ...
        prepared = prepare_retrieval_source_results(jobs, current_data=state.get("current_data"))
        updated_state = {
            **state,
            "source_results": prepared["source_results"],
            "current_datasets": prepared["current_datasets"],
