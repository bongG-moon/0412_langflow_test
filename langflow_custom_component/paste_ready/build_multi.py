...
build_multi_retrieval_response = lf_runtime_services_runtime_service_build_multi_retrieval_response


class BuildMultiComponent(Component):
    display_name = "Build Multi"
    description = "Create the overview response for multi retrieval without extra analysis."
    documentation = "https://docs.langflow.org/components-custom-components"
    icon = "PanelsTopLeft"
    name = "build_multi"

    inputs = [
        DataInput(name="state", display_name="State", info="Multi retrieval state after execute_jobs"),
        *llm_settings_inputs(),
    ]
    outputs = [Output(name="state_out", display_name="State", method="build_response", types=["Data"], selected="Data")]
    ...
    def build_response(self):
        ...
        self.status = "Built multi response"
