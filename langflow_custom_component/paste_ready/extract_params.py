...
apply_context_inheritance = __lf_runtime_services_parameter_service__apply_context_inheritance
resolve_required_params = __lf_runtime_services_parameter_service__resolve_required_params
build_recent_chat_text = __lf_runtime_services_request_context__build_recent_chat_text
get_current_table_columns = __lf_runtime_services_request_context__get_current_table_columns


class ExtractParamsComponent(Component):
    display_name = "Extract Params"
    description = "Extract retrieval parameters and keep both raw values and inherited context values."
    documentation = "https://docs.langflow.org/components-custom-components"
    icon = "Filter"
    name = "extract_params"

    inputs = [DataInput(name="state", display_name="State", info="Session state from the previous node")]
    outputs = [Output(name="state_out", display_name="State", method="extract_params", types=["Data"], selected="Data")]
    ...
    def extract_params(self):
        ...
        updated_state = {**state, "raw_extracted_params": raw_extracted_params, "extracted_params": extracted_params}
