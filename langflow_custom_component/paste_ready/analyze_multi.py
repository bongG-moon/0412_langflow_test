...
run_multi_retrieval_analysis = lf_runtime_services_runtime_service_run_multi_retrieval_analysis


class AnalyzeMultiComponent(Component):
    display_name = "Analyze Multi"
    ...
    def run_analysis(self):
        ...
        self.status = "Multi analysis complete"
