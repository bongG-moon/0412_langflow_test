...
build_single_retrieval_response = __lf_runtime_services_runtime_service__build_single_retrieval_response


class BuildSingleComponent(Component):
    display_name = "Build Single"
    description = "Create the final direct response for a single retrieval path."
    ...
    def build_response(self):
        ...
        self.status = "Built single response"
