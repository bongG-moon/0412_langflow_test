...
build_retrieval_jobs = __lf_runtime_services_retrieval_planner__build_retrieval_jobs
validate_retrieval_jobs = __lf_runtime_services_runtime_service__validate_retrieval_jobs


class BuildJobsComponent(Component):
    display_name = "Build Jobs"
    ...
    outputs = [Output(name="state_out", display_name="State", method="build_jobs", types=["Data"], selected="Data")]
    ...
    def build_jobs(self):
        ...
        jobs = build_retrieval_jobs(user_input, extracted_params, retrieval_keys) if retrieval_keys else []
        ...
        if validation_error is not None:
            updated_state["result"] = validation_error
            self.status = "Retrieval validation blocked execution"
