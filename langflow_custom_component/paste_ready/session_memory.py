...
import json as __lf_workflow__json
from typing import Any as __lf_workflow__Any, Dict as __lf_workflow__Dict, List as __lf_workflow__List

def __lf_workflow___coerce_json_field(value: __lf_workflow__Any, default: __lf_workflow__Any) -> __lf_workflow__Any:
    ...
    if isinstance(value, (dict, list)):
        return value
    try:
        return __lf_workflow__json.loads(str(value))
    except Exception:
        return default

def __lf_workflow__build_initial_state(user_input: str, chat_history: __lf_workflow__List[__lf_workflow__Dict[str, str]] | str | None=None, context: __lf_workflow__Dict[str, __lf_workflow__Any] | str | None=None, current_data: __lf_workflow__Dict[str, __lf_workflow__Any] | str | None=None, domain_rules_text: str | None=None, domain_registry_payload: __lf_workflow__Dict[str, __lf_workflow__Any] | __lf_workflow__List[__lf_workflow__Any] | str | None=None) -> __lf_workflow__Dict[str, __lf_workflow__Any]:
    """Build the shared state contract used across standalone Langflow nodes."""
    return {'user_input': str(user_input or ''), 'chat_history': __lf_workflow___coerce_json_field(chat_history, []), 'context': __lf_workflow___coerce_json_field(context, {}), 'current_data': __lf_workflow___coerce_json_field(current_data, None), 'domain_rules_text': str(domain_rules_text or '').strip(), 'domain_registry_payload': __lf_workflow___coerce_json_field(domain_registry_payload, {})}
...
MessageInput = __lf_component_base__MessageInput
MessageTextInput = __lf_component_base__MessageTextInput
...
append_history = __lf_node_utils__append_history
read_domain_registry_payload = __lf_node_utils__read_domain_registry_payload
read_domain_text_payload = __lf_node_utils__read_domain_text_payload
read_message_text = __lf_node_utils__read_message_text
build_initial_state = __lf_workflow__build_initial_state
