...
route_single_post_processing = __lf_runtime_services_runtime_service__route_single_post_processing


class RouteSingleComponent(Component):
    display_name = "Route Single"
    description = "Expose direct-response vs post-analysis branch for single retrieval."
    ...
    outputs = [
        Output(name="direct_out", display_name="Direct", method="direct_state", group_outputs=True, types=["Data"], selected="Data"),
    ...
    def _resolve(self) -> Tuple[Dict[str, Any], str]:
        ...
        route = route_single_post_processing(
            user_input=state.get("user_input", ""),
            source_results=state.get("source_results", []),
            extracted_params=extracted_params,
            retrieval_plan=state.get("retrieval_plan"),
        ) if state else ""
        self.status = f"Single route: {route or 'inactive'}"
