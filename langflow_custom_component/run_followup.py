...
run_followup_analysis = lf_runtime_services_runtime_service_run_followup_analysis


class RunFollowupComponent(Component):
    display_name = "Run Followup"
    description = "Execute the follow-up analysis path on the current table."
    documentation = "https://docs.langflow.org/components-custom-components"
    icon = "RefreshCw"
    name = "run_followup"

    inputs = [
        DataInput(name="state", display_name="State", info="State with current_data and extracted_params"),
        *llm_settings_inputs(),
    ]
    outputs = [Output(name="state_out", display_name="State", method="run_followup", types=["Data"], selected="Data")]
