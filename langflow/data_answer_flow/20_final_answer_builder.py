...
class FinalAnswerBuilder(Component):
    ...
    inputs = [
        DataInput(name="answer_llm_output", display_name="Answer LLM Output", info="Output from LLM API Caller connected after Build Answer Prompt.", input_types=["Data", "Message", "Text", "JSON"]),
