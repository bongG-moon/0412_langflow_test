...
class BuildAnswerPrompt(Component):
    ...
    description = "Build the prompt payload for the LLM API Caller to summarize the analysis result in Korean."
    icon = "MessageCircle"
    ...
    def build_prompt_payload(self) -> Data:
        return _make_data({"prompt": self.build_prompt_text(), "prompt_type": "answer_text"})
