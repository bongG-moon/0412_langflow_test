...
이제 Main Flow의 기본 도메인 입력 경로는 다음과 같다.
...
```text
MongoDB Domain Payload Loader.domain_payload -> Build Intent Prompt.domain_payload
MongoDB Domain Payload Loader.domain_payload -> Normalize Intent With Domain.domain_payload
MongoDB Domain Payload Loader.domain_payload -> Query Mode Decider.domain_payload
```
