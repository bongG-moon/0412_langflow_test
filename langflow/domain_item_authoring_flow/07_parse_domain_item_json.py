...
class ParseDomainItemJSON(Component):
    ...
    description = "Parse JSON text from the Domain Item LLM API Caller into raw domain item candidates."
    icon = "Braces"
    ...
    inputs = [
        DataInput(
            ...
            info="Output from Domain Item LLM API Caller, Message, or Data payload.",
